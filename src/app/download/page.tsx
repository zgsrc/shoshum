...
const DOWNLOADS: DownloadOption[] = [
  ...
  },
  {
    ...
    fileName: "Shoshum-x86_64.AppImage",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
    ...
    variants: [
      { label: "AppImage (x64)", fileName: "Shoshum-x86_64.AppImage" },
      { label: "AppImage (ARM64)", fileName: "Shoshum-aarch64.AppImage" },
      { label: "Debian (x64)", fileName: "shoshum_amd64.deb" },
      { label: "Debian (ARM64)", fileName: "shoshum_arm64.deb" },
    ],
  },
];
